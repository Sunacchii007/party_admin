...
switch($method) {
    ...
    case "POST":
        ...
        $sql = "INSERT INTO users(id, nomComplet, adresse,email,telephone ) VALUES(null, :nomComplet ,:adresse , :email,:telephone )";
        $stmt = $conn->prepare($sql);
        ...
        case "PUT":
            ...
            $sql = "UPDATE users SET nomComplet = :nomComplet, adresse = :adresse, email = :email, telephone = :telephone  WHERE id = :id";
            $stmt = $conn->prepare($sql);
